...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='nets/double/flow.rou.xml', help="Route definition xml file.\n")
    ...
    prs.add_argument("-maxgreen", dest="max_green", type=int, default=300, required=False, help="Maximum green time.\n")
    ...
    prs.add_argument("-s", dest="seconds", type=int, default=30000, required=False, help="Number of simulation seconds.\n")
